...
short_description: "Mercado del sur de Alberta, a 215 km de Calgary — fuera del conjunto clasificado Top-400 actual."
...
sitúa fuera de la banda suburbano-regional de 15 a 80 km que utiliza la clasificación, lo que
...
minería del carbón y la agricultura a finales del siglo XIX hacia un modelo diversificado
basado en servicios. Park Place Mall ocupa terrenos de antiguos patios ferroviarios entre
Scenic Drive y Stafford Drive. Conocida como "la Ciudad Ventosa", Lethbridge tiene el segundo
mayor número de días de viento fuerte de cualquier ciudad canadiense.

## Posición en el Mercado Regional

Lethbridge no aparece actualmente en la lista clasificada
...
aplica la clasificación. Esto no es un defecto de datos; refleja la clasificación del mercado
...
- [Lethbridge](https://en.wikipedia.org/wiki/Lethbridge) — Wikipedia, consultado 2026-07-10
