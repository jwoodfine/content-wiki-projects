...
In the current dataset, "Greenville SC" functions as the metro-core reference point that two
other markets — Spartanburg, SC (rank 45) and Asheville, NC (rank 104) — are ranked as
suburbs *of*, rather than as a suburban market itself.

## Overview

According to Wikipedia (accessed 2026-07-10), Greenville's city proper had 70,720 residents
at the 2020 census across 30.02 square miles (metropolitan area approximately 1 million),
serving as the anchor city of Upstate South Carolina, positioned roughly midway between
...
company's only full manufacturing plant in North America — which employed roughly 8,800
...
other suburban entries (Spartanburg, rank 45, score 9.0; Asheville, rank 104, score 7.5),
consistent with [[about-regional-markets-system|the co-location scoring system's]] own
taxonomy excluding metro cores from the suburban-regional ranked pool.
