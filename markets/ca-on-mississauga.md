...
**Table 1.** Mississauga co-location clusters.

| Cluster | Tier | Anchor Composition | Representative Members |
|---|---|---|---|
| 1 | T1 | Hypermarket + Hardware + Price Club | Walmart, Canadian Tire, Costco, Mississauga Hospital (×2) |
| 2 | T1 | Hypermarket + Hardware + Price Club | Walmart, The Home Depot, Canadian Tire, Costco |
| 3 | T2 | Hypermarket + Hardware | Real Canadian Superstore, The Home Depot, Canadian Tire, Mississauga Hospital, University of Toronto Mississauga |
| 4 | T3 | Hardware + Price Club | The Home Depot, Canadian Tire, Costco, Credit Valley Hospital, University of Toronto Mississauga |
| 5 | T3 | Hypermarket + Hardware | Walmart, Real Canadian Superstore, The Home Depot, Canadian Tire, LifeLabs Medical Laboratory Services |

## Civic Infrastructure

Mississauga's civic anchor set is unusually strong for a suburban-regional market. Two of the five clusters attach to Mississauga Hospital and one attaches to Credit Valley Hospital. Both hospitals are operated by Trillium Health Partners, the regional acute-care network for the western Greater Toronto Area, and together they form one of the largest community hospital systems in Ontario. A fifth cluster includes a LifeLabs Medical Laboratory Services site, extending the medical footprint into the outpatient diagnostic layer.
...
**Table 2.** Mississauga AEC data layers.

| Layer | Value |
|---|---|
| Köppen-Geiger | Dfa (Hot-Summer Humid Continental) |
| WWF Ecoregion | Southern Great Lakes forests |
| WWF Biome | Temperate Broadleaf & Mixed Forests |
| ASHRAE Climate Zone | Not available (ASHRAE coverage is United States only; Mississauga is in Canada) |
