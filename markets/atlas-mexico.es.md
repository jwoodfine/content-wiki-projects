...
title: "México — Índice de mercados regionales"
slug: atlas-mexico
category: markets
type: topic
...
diario de ese núcleo. Todos los 46 puntos de referencia de México se ubican dentro del propio
país, repartidos entre 16 núcleos metropolitanos distintos — Ciudad de México para ocho
entradas, y Guadalajara, Hermosillo, Monterrey, Oaxaca y Puebla para cuatro cada uno. Ningún
mercado mexicano hace referencia a un núcleo al otro lado de una frontera, aunque los núcleos
mexicanos sí actúan como punto de referencia para tres mercados estadounidenses del mismo
conjunto. La distancia mediana de referencia de México es de 152 kilómetros, frente a 75 en
Estados Unidos y 90 en Canadá, y su distancia máxima — 694 kilómetros — es la mayor registrada
en todo el conjunto publicado.

Las cifras de población de la cuenca de influencia y de gasto de consumo constan para los 46
mercados mexicanos, sin lagunas. Son contexto descriptivo únicamente y no intervienen en la
selección.

## Composición de clústeres

Los 46 mercados suman 115 clústeres de co-ubicación — 54 de Nivel 1, tres de Nivel 2 y 58 de
Nivel 3. México es el único país de cualquiera de los dos conjuntos continentales en el que los
clústeres de Nivel 3 superan en número a los de Nivel 1. Cuarenta y cinco de los 46 cuentan con
al menos un clúster de Nivel 1, de modo que el peso del Nivel 3 refleja clústeres adicionales
de ancla única junto a un núcleo calificador de Nivel 1, y no una base de calificación más
débil.
...
| Naucalpan de Juárez | Ciudad de México | 12,8 | 1 | 1 | 1 |
| Álvaro Obregón | Ciudad de México | 12,9 | 3 | 0 | 1 |
| Apodaca, Nuevo León | Monterrey | 13,5 | 1 | 1 | 2 |
| Tlajomulco de Zúñiga | Guadalajara | 14,4 | 1 | 0 | 2 |
| Playas de Rosarito | Tijuana | 15,0 | 1 | 0 | 0 |
| Tlalnepantla de Baz | Ciudad de México | 15,4 | 2 | 0 | 1 |
| Tlalpan | Ciudad de México | 15,5 | 1 | 0 | 1 |
| Ecatepec de Morelos | Ciudad de México | 19,0 | 1 | 0 | 5 |
| Texcoco, MX | Ciudad de México | 25,3 | 1 | 0 | 1 |
| Ixtapaluca | Ciudad de México | 30,3 | 1 | 0 | 0 |
| Tulancingo de Bravo | Pachuca | 39,2 | 1 | 0 | 0 |
| Celaya, Guanajuato | Querétaro | 44,6 | 2 | 0 | 0 |
| Toluca | Ciudad de México | 55,1 | 1 | 0 | 3 |
...
- [[atlas-top-400-north-america]] — el conjunto continental Top 400 de América del Norte del que esta página filtra
- [[about-regional-markets-system]] — la metodología de co-ubicación y los criterios de selección de mercados
- [[atlas-co-location-index-mexico]] — la red mexicana de anclas de co-ubicación; cubre la convergencia de anclas subyacente en lugar de filtrar este conjunto
