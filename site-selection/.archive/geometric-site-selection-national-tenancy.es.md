...
paired_with: site-selection/geometric-site-selection-national-tenancy.md
---
...
Un clúster con span_km < 1,0 km es *compacto-intacto* — todos los miembros se encuentran dentro de una distancia coherente con un único Power Centre o campus minorista. Un clúster con span_km ∈ (1,0; 3,0] es *laxo* — los miembros están distribuidos a lo largo de un corredor comercial.
