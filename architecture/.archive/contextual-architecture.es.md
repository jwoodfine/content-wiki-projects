...
short_description: "Enfoque de diseño que otorga prioridad a la relación entre un edificio nuevo y su entorno existente — escala, material, volumen y uso — por encima de la lógica formal interna del propio edificio."
paired_with: contextual-architecture.md
tags:
  - domain:projects
...
thesis_alignment: "El diseño contextual es la disciplina arquitectónica que rige la forma en que un edificio nuevo o renovado encaja en un nodo comercial consolidado — su éxito o fracaso incide directamente en la coherencia del nodo, su atractivo peatonal y la estabilidad de la coinquilinidad a largo plazo."
keynote: true
