...
short_description: "Formas constructivas determinadas por materiales locales, clima y convención comunitaria, más que por formación arquitectónica formal — una categoría que define el carácter de la mayor parte del parque comercial y de uso mixto en los mercados secundarios."
paired_with: vernacular-architecture.md
tags:
  - domain:projects
...
thesis_alignment: "El parque vernáculo es el principal soporte físico de la colocalización en los mercados secundarios, donde la convención constructiva — no la intención arquitectónica — determina la geometría de la planta, la altura libre y los patrones de proximidad entre inquilinos."
keynote: true
...
El parque comercial vernáculo está fuertemente concentrado en los nodos que anclan la [[co-location-strategy|colocalización]] en mercados secundarios. Los inquilinos de servicios profesionales — clínicas dentales, optometristas, fisioterapeutas, asesores financieros y corredores de seguros — ocupan preferentemente franjas vernáculas y bloques de uso mixto de baja altura adyacentes al comercio anclado en supermercados. La configuración de módulos pequeños del tipo de edificio y su orientación hacia el aparcamiento en superficie se alinean con los requisitos operativos de las empresas de servicios que dependen de un acceso cómodo en vehículo privado.
