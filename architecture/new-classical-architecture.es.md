...
La Nueva Arquitectura Clásica, también denominada Nuevo Clasicismo o Arquitectura Clásica Contemporánea, es un movimiento contemporáneo que continúa la práctica de la arquitectura clásica. Se considera a veces la continuación moderna de la arquitectura neoclásica, aunque también recurre a las tradiciones clásicas gótica, barroca, renacentista y no occidental — con frecuencia desde una perspectiva posmoderna más que como estricto revivalismo histórico. El movimiento sostiene que las prácticas arquitectónicas clásicas y tradicionales representan una disciplina viva y no un artefacto histórico, y que los edificios contemporáneos diseñados según principios clásicos no son imitaciones del pasado sino expresiones legítimas de una continuidad arquitectónica que abarca milenios.
