...
**Clases de Desarrollo.** La taxonomía categórica de los tipos de edificio de Woodfine: Centros Profesionales, Oficinas Suburbanas, Retail Select, Industrial Tecnológico, Estructuras de Estacionamiento y Almacenes Verticales. Definición completa de cada una: [[about-development-classes|Clases de desarrollo]].
...
**Programa de Expansión.** El programa país por país de repetir un diseño de Prototipo estandarizado en múltiples sitios por razones de eficiencia y escalabilidad. Definición completa: [[rollout-index|Programa de Desarrollo Previsto]].
