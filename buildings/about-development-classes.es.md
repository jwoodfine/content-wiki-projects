...
**Corrección (2026-07-16):** esta sección describía anteriormente el Industrial Tecnológico
como planificado y aún no finalizado. Eso está desactualizado — `class-tech-industrial.md`
ha alcanzado desde entonces `quality: complete`/`status: active` con un formato
completamente especificado, corregido aquí para reflejarlo.

El Industrial Tecnológico es un formato de edificio industrial-minorista de un solo piso que atiende a ocupantes adyacentes a la tecnología y de logística de última milla dentro de la huella de co-localización — soporte de procesamiento de datos, ensamblaje ligero, taller y usos adyacentes a investigación y desarrollo. A diferencia de las cuatro clases regidas por proximidad anteriores, el Industrial Tecnológico sigue una configuración fija de 25% escaparate minorista / 75% piso de taller con acceso a nivel de suelo para furgonetas de reparto, funcionando como formato de relleno junto al Retail Select en lugar de un despliegue independiente.

## [[class-parking-structures|Estructuras de Estacionamiento]]
...
## [[class-vertical-warehouses|Almacenes Verticales]]
...
- [[about-development-class-economics|Economía de las Clases de Desarrollo]] — tamaño de placa de piso, plazo de arrendamiento y perfil de inquilino por clase
- [[mix-of-use|Mix of Use]] — el modelo de curaduría de inquilinos aplicado dentro de cada edificio
- [[woodfine-development-vocabulary|Vocabulario de Desarrollo]] — el glosario de términos propietarios en el que se basan este artículo y los seis artículos de clase
