...
- [[zoning-acquisition-rules]] — pre-acquisition verification that triggers the ledger
- [[asset-architecture-standard]] — structural specification that the ledger records compliance with
