...
paired_with: gis/uk-eu-food-retail-coverage.md
cites:
  - osm-odbl
  - ni-51-102
  - osc-sn-51-721
...
El [[co-location-methodology|índice de co-localización]] distingue entre las cadenas minoristas que participan en el algoritmo de puntuación de clústeres — [[co-location-anchors|anclas]], ferreterías, clubes de almacén — y las cadenas que aparecen en el mapa como contexto de apoyo pero no afectan las calificaciones de los clústeres. La familia Alimentación pertenece a este segundo grupo dentro de la [[retail-brand-family-taxonomy|taxonomía de familias de marcas minoristas]]. Este artículo documenta la cobertura de retail alimentario en el Reino Unido y la Unión Europea tras la expansión de mayo de 2026.

## Por qué la Alimentación es sólo datos de contexto

La [[co-location-methodology|metodología de co-localización]] mide la convergencia de tiendas ancla de gran formato: hipermercados, ferreterías, clubes de almacén. Añadir una cadena de supermercados al [[co-location-ranking-system|algoritmo de puntuación]] diluiría la señal — la mayoría de las áreas urbanas tienen muchos operadores de alimentación, por lo que una "co-localización" de un ancla y un supermercado aportaría información limitada sobre la densidad comercial. Mantener la familia Alimentación exclusivamente como capa de datos preserva el índice como medida de la convergencia de anclas de gran formato, mientras muestra a los operadores de campo el contexto minorista más amplio alrededor de un ancla.
