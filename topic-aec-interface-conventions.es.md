...
slug: topic-aec-interface-conventions
language: es
category: bim
type: topic
content_type: topic
...
El [[topic-building-design-system-bim|Sistema de Diseño de la Construcción]] define diez componentes de interfaz que aparecen en cada superficie — ya sea el cliente de campo, la consola de gestión de instalaciones o cualquier superficie futura que consuma el Sistema de Diseño de la Construcción.
