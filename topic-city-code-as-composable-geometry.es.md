...
**Capa 1: Identidad semántica mediante bSDD.** Cada [[topic-bim-objects-what-they-are|Objeto BIM]] lleva una URI de concepto bSDD que identifica su tipo de elemento de manera neutral a la jurisdicción y a la herramienta.
