...
- [[city-code-as-composable-geometry]] — Un modelo arquitectónico que codifica requisitos regulatorios directamente en especificaciones de elementos como restricciones geométricas y numéricas en lugar de aplicarlas después del diseño, haciendo que las configuraciones no conformes sean estructuralmente imposibles por construcción.
- [[gis-as-bim-substrate]] — Lo que el dataset de co-ubicación GIS de PointSav ofrece a un canal de composición BIM: campos del manifold de clusters, capas de contexto cívico y garantías de estabilidad.
