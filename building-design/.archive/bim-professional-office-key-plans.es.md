...
es_status: complete
paired_with: building-design/bim-professional-office-key-plans.md
---

Oficina Profesional es la categoría superordinada para cinco sub-tipos: [[bim-business-key-plans|Empresarial]], [[bim-medical-key-plans|Médico]], Laboratorio, Académico y Cívico. Conserva una línea base de "Diseño Inicial" que precede a la especialización por sub-tipos y se preserva como linaje de diseño. La geometría de la suite se calcula mediante la [[bim-building-width-method|Calculadora de Anchura del Edificio]] y los valores por tipo de uso catalogados en [[bim-zone-depths-per-use-type|profundidades de zona por tipo de uso]]; las Plantas Clave alimentan el [[bim-tile-system|sistema de teselas]] y la [[bim-floor-plate-methodology|metodología de la planta]].
...
El sistema de [[bim-key-plans-index|Planos Clave]] reconoce once categorías de inquilinos: Oficina Privada, cinco sub-tipos de Oficina Profesional ([[bim-business-key-plans|Empresarial]], [[bim-medical-key-plans|Médico]], Laboratorio, Académico, Cívico) y cinco tamaños de Oficina Corporativa (1/8, 1/4, 1/2, 3/4 y Planta Completa).
