...
slug: bim-zone-depths-per-use-type
...
status: archived
archived: 2026-08-24
archived_reason: "Retracted -- frontmatter already marked bcsc_class: vendor-internal but the file was published anyway; real internal working data (exact measurements, TODO checklists, internal doc citations, operator workflow notes) not intended for public disclosure. Track-B integrity review, 2026-08-24."
superseded_by: none
audience: operator
...
paired_with: building-design/bim-zone-depths-per-use-type.es.md
---

> **Companion:** [[bim-building-width-method]] for the formula and the mirror cross-section.

This article catalogues the per-side zone depths feeding the [[bim-tile-system|Tile system]] and the [[bim-floor-plate-methodology|floor plate methodology]]; the inventory of named Key Plans is in [[bim-key-plans-index|the Key Plans index]]. Sub-type specialisations are documented under [[bim-professional-office-key-plans|Professional Office]] and its [[bim-medical-key-plans|Medical]], [[bim-business-key-plans|Business]], and [[bim-private-office-key-plans|Private Office]] sub-articles.
...
|---|---|---|---|---|---|
| [[bim-private-office-key-plans|Private Office]] | 5.9944 m / 19'8" | 1.3716 m / 4'6" | — | **14.73 m / 48'4"** | PO-1/PO-2/PO-3 sketches |
| Academic | 4.7 m / 15'5" | 3.0 m / 9'10" | — | **15.40 m / 50'6"** | Summary V2, 2025-05-13 |
| [[bim-professional-office-key-plans|Professional Office]] (V12 baseline) | 6.0 m / 19'8" | 3.0 m / 9'10" | 3.0 m / 9'10" | **21.00 m / 68'11"** | V12, 2025-01-07 (Z2/Z3 marked TBD) |
| Laboratory | 6.7818 m / 22'3" | 4.8006 m / 15'9" | 3.048 m / 10'0" | **26.21 m / 86'0"** | Summary V2; IBC high-hazard egress |
| [[bim-medical-key-plans|Medical]] | 7.2819 m / 23'10" | 4.877 m / 16'0" | 2.892 m / 9'5" | **27.20 m / 89'3"** | M3/M1/M2 sketches (286 5/8" + 192" + 113 7/8") |
| [[bim-business-key-plans|Business]] | 5.51 m / 18'1" | 9.26 m / 30'5" | 2.75 m / 9'0" | **29.30 m / 96'2"** | Notes V3 Option A/A (widest enumerated) |
| Civic | 6.0 m / 19'8" | 7.23 m / 23'9" | 3.6 m / 11'10" | **30.06 m / 98'8"** | Synthesised values; no completed sketch |

Formula: `Width = 2 × (Z1 + Z2) + Z3`. See [[bim-building-width-method]] for the derivation.
