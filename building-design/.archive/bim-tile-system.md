...
paired_with: building-design/bim-tile-system.es.md
---

A Tile is a rectangular composable unit of the [[bim-floor-plate-methodology|floor plate]]. Each Tile is exactly one HVAC climate zone. Tiles compose to fill the Net Leasable Area without remainder. The system is defined alongside the catalogue of [[bim-key-plans-index|Key Plans]] and the per-use-type [[bim-zone-depths-per-use-type|zone depths]] that determine each Tile's interior geometry.

There are three regular tile families (Small, Medium, Large) and one residual family (Special Tiles). Sample assemblies appear in [[bim-floor-plate-tile-combinations|floor-plate tile combinations]].
...
| Tile B-1 | [[bim-private-office-key-plans|Private Office]] | 5 PO (300 + 500 + 450 + 300 + 300) + Professional Small 800 ≈ 2,700 SF | 6 | Private-office heavy interior |
| Tile C-1 | [[bim-professional-office-key-plans|Professional Office]] (Med + Med + Small) | PO-M 2,000 + PO-M 450 + PO-S 300 = 2,750 | 3 | Professional anchor ([[bim-medical-key-plans|Medical]], [[bim-business-key-plans|Business]]) |
