...
slug: bim-professional-office-key-plans
...
paired_with: building-design/bim-professional-office-key-plans.es.md
---

Professional Office is the superordinate category for five sub-types: [[bim-business-key-plans|Business]], [[bim-medical-key-plans|Medical]], Laboratory, Academic, and Civic. It carries an "Initial Design" baseline that pre-dates the sub-type specialisation and is preserved as design lineage. Suite geometry is computed using the [[bim-building-width-method|Building Width Calculator]] and the per-use-type values catalogued in [[bim-zone-depths-per-use-type|zone depths per use type]]; the Key Plans feed the [[bim-tile-system|Tile system]] and the [[bim-floor-plate-methodology|floor plate methodology]].
...
A generic Professional Office tenant who does not fall into any of the five specialisations uses the Initial Design baseline at 130 m² / 1,400 SF. In practice this is rare: most professional-services firms self-identify as [[bim-business-key-plans|Business]], clinical practices as [[bim-medical-key-plans|Medical]], and research operations as Laboratory.
...
- [[bim-key-plans-index]]
- [[bim-business-key-plans]]
- [[bim-medical-key-plans]]
