...
La Oficina Empresarial (Oficina Profesional — Empresarial) es uno de los cinco sub-tipos de [[bim-professional-office-key-plans|Oficina Profesional]]. Su característica distintiva es la Zona 2 Revista a 7,3 m — la más ancha de cualquier sub-tipo — impulsada por paredes de almacenamiento abierto, salas de servidores, áreas de impresión y zonas de colaboración propias de firmas de servicios profesionales. La profundidad se calcula mediante la [[bim-building-width-method|Calculadora de Anchura del Edificio]] y alimenta el [[bim-tile-system|sistema de teselas]] que compone la [[bim-floor-plate-methodology|planta]].
