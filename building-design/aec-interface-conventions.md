...
The [[design-system-bim|Building Design System]] defines ten interface components that appear on every surface — whether the field client, the facility management console, or any future surface that consumes the Building Design System.
