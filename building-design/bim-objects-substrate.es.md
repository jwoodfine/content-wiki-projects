...
Cada Objeto BIM del [[design-system-bim|Sistema de Diseño de la Construcción]] se mapea a una clase de entidad IFC específica o a un Pset.
...
El [[design-system-bim|Sistema de Diseño de la Construcción]] agrupa los Objetos BIM en ocho categorías, cada una mapeada a una capa distinta del modelo de entidades IFC.
