...
## Elimination of design variation
...
The standard is applied in conjunction with the [[co-location-anchors|co-location anchor]] adjacency requirement. A site that passes the architectural standard but fails the anchor proximity test — or vice versa — does not proceed. The two criteria are applied together, not sequentially.
