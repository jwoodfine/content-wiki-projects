...
The [[topic-bim-objects-what-they-are|BIM Object]] layer of the Building Design System is organised into eight primitive categories, each corresponding to a cluster of IFC 4.3 entity types. This structure mirrors the organisation of software [[design-system-substrate|design system]] token primitives but is anchored to the IFC entity hierarchy rather than to visual design properties.
...
**8. Climate Zones** — Performance parameter tables keyed to climate zone identifiers (ASHRAE 90.1 zones 1A through 8, Canadian NBC climate zones, and European EN ISO 52000 zones). Each row is one climate zone × one element type × one performance parameter. See [[topic-bim-objects-three-layers]] for the full Climate Zone layer specification.

## The AEC Interface Component Layer

Above the [[topic-bim-objects-substrate|BIM Object primitive layer]], the Building Design System defines a set of [[topic-aec-interface-conventions|universal AEC interface components]] — UI patterns common to any BIM-capable authoring surface regardless of the specific programme type.
